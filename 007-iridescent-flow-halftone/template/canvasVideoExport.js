let projectName = "iridescent-flow-halftone";
...
function toggleVideoRecord(){
  ...
  const recordButton = document.getElementById('exportVideoBtn');
  if (recordButton) recordButton.classList.toggle('recording', recordVideoState);
}
